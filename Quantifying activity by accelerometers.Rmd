...
corMatrix <- cor(trainSet[, colnames(trainSet)!="classe"])
corrplot(corMatrix, order = "FPC", method = "number", type = "lower", 
...
#training_clc <- training[rowSums(is.na(training[,1:160]))==0,] 
#model_gbm <- train(classe~., data = training_clc, method= "gbm")
